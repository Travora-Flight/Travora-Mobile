...
class CarAirportDetailsScreen extends StatefulWidget {
  final int orderId;

  const CarAirportDetailsScreen({super.key, required this.orderId});

  @override
  State<CarAirportDetailsScreen> createState() =>
      _CarAirportDetailsScreenState();
}

class _CarAirportDetailsScreenState extends State<CarAirportDetailsScreen> {
          ...
          AppointmentDetailsCard(
            ...
            onChangeDate: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      ChangePickupTimeScreen(orderId: widget.orderId),
                ),
              );
            },
          ),
