...
import '../webview_screen/payment_webview_screen.dart';
import 'order_success_screen.dart';
import '../../widgets/order_review_card.dart';
import '../../services/bag_tracking_service/order_review_service.dart';
...
class _OrderReviewScreenState extends State<OrderReviewScreen> {
  final BagTrackingOrderService _orderService = BagTrackingOrderService();
  ...
  Future<void> _loadData() async {
    try {
      ...
      final BagTrackingInvoiceModel invoice =
          results[0] as BagTrackingInvoiceModel;
              ...
              children: [
                Padding(
                  ...
                  child: OrderReviewWidget(
                    serviceName: "Bag Tracking Service",
                    userName: _userName,
